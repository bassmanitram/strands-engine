...
from .types import (
    ToolSpecData,
    CONFIG_FIELD_ID, CONFIG_FIELD_TYPE, CONFIG_FIELD_COMMAND, CONFIG_FIELD_ARGS,
    CONFIG_FIELD_ENV, CONFIG_FIELD_URL, CONFIG_FIELD_FUNCTIONS,
    DEFAULT_MCP_SERVER_ID, DEFAULT_TOOL_ID,
    ERROR_MSG_MCP_DEPS_NOT_INSTALLED, ERROR_MSG_MCP_TRANSPORT_MISSING,
    ERROR_MSG_MCP_TRANSPORT_DEPS, ERROR_MSG_UNEXPECTED_ERROR
)
...
def create_mcp_tool_spec(config: ToolConfig) -> ToolSpecData:
    ...
    logger.trace("create_mcp_tool_spec called for server_id='{}', functions={}", server_id, functions)
