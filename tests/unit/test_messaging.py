...
class TestContentUtils:
    ...
    def test_recursively_remove_from_dict(self):
        ...
        data = {
            ...
            "keep2": {
                ...
                "deep": {"remove_me": "should_be_removed_deep", "keep_deep": "value3"},
            },
        }
        ...
        expected = {
            "keep1": "value1",
            "keep2": {"nested_keep": "value2", "deep": {"keep_deep": "value3"}},
        }
    ...
    def test_recursively_remove_from_list(self):
        ...
        expected = [{"keep": "value1"}, {"keep": "value2"}, [{"keep": "value3"}]]
...
class TestMessageGenerator:
    ...
    def test_create_file_content_blocks(self, mock_generate, temp_dir):
        ...
        file_paths = [(str(file1), "text/plain"), (str(file2), "text/plain")]
    ...
    def test_generate_llm_messages_with_file_references(self, mock_resolve, temp_dir):
        ...
        with patch(
            "strands_agent_factory.messaging.generator._create_file_content_blocks"
        ) as mock_create:
    ...
    def test_generate_llm_messages_mixed_content(self):
        ...
        with patch(
            "strands_agent_factory.messaging.generator._resolve_file_glob"
        ) as mock_resolve:
            # Mock no files found
