"""
Framework adapter modules for strands_engine.

This package provides framework-specific adapters that enable strands_engine
...
The adapter system allows strands_engine to remain provider-agnostic while
...
Example:
    >>> from strands_engine.framework import LiteLLMAdapter
